...
exports.forTable = function(conditions) {
  ...
  _.each(conditions, function(value, key) {
    ...
    //we don't need to parameterize bool or numeric queries
    //by definition, SQL Injection doesn't happen with non-strings
    if (_.isBoolean(value) || _.isNumber(value)) {

      //just return the concatenated SQL string
    ...
    //if the conditions anything but bool, number, or array treat as a string
    if (!_.isArray(value)) {
